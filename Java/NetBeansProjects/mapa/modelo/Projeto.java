package br.unicesumar.mapa.modelo;
...
public class Projeto {
	...
	public Projeto(String nome, String objetivo, String necessidades, LocalDate dataInicio, LocalDate dataFinal,
			String status) {
		this.nome = nome;
	...
	public String toString() {
		return "\nProjeto: \n" + "Nome: " + nome + "\n" + "Objetivo: " + objetivo + "\n" + "Necessidades: "
				+ necessidades + "\n" + "Data Inicio: " + dataInicio.format(FORMATO_DATA) + "\n" + "Data Final: "
